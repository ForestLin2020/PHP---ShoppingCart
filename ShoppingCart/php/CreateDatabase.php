<?php
//    $databasename = "epiz_26847162_ShoppingCartDatabase";
//    $tablename = "Productdatabase";
//    $servername = "sql204.epizy.com";
//    $username = "epiz_26847162";
//    $password = "iVG7BykFu5hS5V";
//
//    $connetction = mysqli_connect($servername, $username, $password, $databasename);
//
//    if(!$connetction){
